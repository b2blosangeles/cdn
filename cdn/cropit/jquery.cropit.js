	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function loadImage(imageSrc) {
	      ...
	      this.preImage.src = imageSrc;
			if (this.options.angularjs)  {
				this.options.angularjs._cropit = this;
				this.options.angularjs.resize(imageSrc);  		
			} 
	    }
	  }, {
	    key: 'setImageSrc',
	    ...
	    value: function onImageLoaded() {
		  ...
		  /* --- angularjs plugin */
			if ((this.options.angularjs) && typeof this.options.angularjs.previewChange  == 'function') {
				this.options.angularjs.previewChange('onImageLoaded');
			}				
	    }
	  }, {
	    key: 'onImageError',
	    ...
	    value: function onMove(e) {
		  ...
		  /* --- angularjs plugin */
			if ((this.options.angularjs) && typeof this.options.angularjs.previewChange  == 'function') {
				this.options.angularjs.previewChange('onMove');
			}	
	    ...
	    value: function onZoomSliderChange() {
		  ...
		  /* --- angularjs plugin */
			if ((this.options.angularjs) && typeof this.options.angularjs.previewChange  == 'function') {
				this.options.angularjs.previewChange('onZoomSliderChange');
			}	
